...
switch ($Quizresults) {
    case "ISTJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ISTP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ESTJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ESTP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ISFP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ISFJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ESFP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ESFJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "INFP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "INFJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ENFJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ENFP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "INTJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "INTP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "ENTJ": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
        break;
    case "INTP": $results = get_comp_personalities($Quizresults);
                    echo"General matches = ".$results[0].",".$results[1]/*.",".$results[2].",".$results[3]*/;
...
<?php
  echo"<br> 
       <br> 
       <center>
<form method='post'  action='suggested_users.php'>
...
<td class="col-3">
 ...
 <div id="QRP3" class="PR">
 INTJs are analytical problem-solvers, eager to improve systems and processes with their innovative ideas. They have a talent for seeing possibilities for improvement, whether at work, at home, or in themselves.
Often intellectual, INTJs enjoy logical reasoning and complex problem-solving. They approach life by analyzing the theory behind what they see, and are typically focused inward, on their own thoughtful study of the world around them. INTJs are drawn to logical systems and are much less comfortable with the unpredictable nature of other people and their emotions. They are typically independent and selective about their relationships, preferring to associate with people who they find intellectually stimulatin...(line truncated)...
 </div>          
</td>
