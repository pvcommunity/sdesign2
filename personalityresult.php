...
"(s_id,major,major_imp,social,social_imp,sleep,sleep_imp,cleaning,cleaning_imp)".
" VALUES('$s_id','$s_major','$s_major_imp','$s_social','$s_social_imp','$s_sleep','$s_sleep_imp','$s_cleaning','$s_cleaning_imp')"; 
  mysql_select_db('PV_5.0');
...
<?php
  echo"<br> 
       <br> 
       <center>
<form method='post'  action='suggested_users.php?id=".$id."'>
...
if (isset($_POST ['submit'])) 
{
    ...
    echo"</table>"; 
      ...
      //header("location: suggested_users.php?id=".$id."");
    }
